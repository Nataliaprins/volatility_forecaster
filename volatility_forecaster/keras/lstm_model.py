...
def lstm_model(root_dir, seq_length, train_size, epoch):
    ...
    path_to_data = os.path.join(
        ROOT_DIR_PROJECT, "yahoo", "processed", "prices", "*.csv"
    )
    ...
    for stock in stock_names:
        ...
        history = best_model.fit(
            X_train, y_train, epochs=epoch, validation_data=(X_test, y_test)
        )
...
if __name__ == "__main__":
    lstm_model(root_dir="yahoo", seq_length=7, train_size=0.7, epoch=10)
